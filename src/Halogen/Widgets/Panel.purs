...
import Halogen.Widgets.Style (sty, cls, ink, inkSoft, surface, line, uiFont)
...
panel config body =
  HH.div
    [ cls "hg-panel"
    , sty $ "background:" <> surface <> ";border:1px solid " <> line <> ";border-radius:var(--hw-radius,8px);"
